...
def Aggre_Tran_Transaction_type(df,state):
    ...
    with col1:
        fig_pie_1=px.pie(data_frame=tacyg,names="Transaction_type",values="Transaction_amount",
                        width=600,title=f"{state.upper()} TRANSACTIN AMOUNT",hole=0.5)
        st.plotly_chart(fig_pie_1)
    with col2:
        fig_pie_2=px.pie(data_frame=tacyg,names="Transaction_type",values="Transaction_count",
                        width=600,title=f"{state.upper()} TRANSACTIN COUNT",hole=0.5)
...
def Aggre_user_plot_1(df,year):
    ...
    fig_bar_1= px.bar(aguyg,x="Brands",y="Transaction_count",title=f"{year}Brands AND Transaction_count",
...
def Aggre_user_plot_2(df,quarter):
    ...
    fig_bar_1= px.bar(aguyqg,x="Brands",y="Transaction_count",title=f"{quarter} QUARTER BRANDS AND TRANSACTION_COUNT",
                        width=1000, color_discrete_sequence= px.colors.sequential.haline_r,hover_name="Brands")
    st.plotly_chart(fig_bar_1)
...
def map_insur_Districts(df,state):
    ...
    with col1:
        fig_bar_1=px.bar(tacyg,x="Transaction_amount",y="Districts",orientation="h",height=600,
                        title=f"{state.upper()}DISTRICTS AND TRANSACTIN AMOUNT",color_discrete_sequence=px.colors.sequential.Mint_r)
        st.plotly_chart(fig_bar_1)
    with col2:
        fig_bar_2=px.bar(tacyg,x="Transaction_count",y="Districts",orientation="h",height=600,
                        title=f"{state.upper()}DISTRICTS AND TRANSACTIN COUNT",color_discrete_sequence=px.colors.sequential.Bluered_r)
...
def map_user_plot_2(df,quarter):
    ...
    fig_line_1= px.line(muyqg,x="States",y=["RegisteredUsers","AppOpens"],
                        title= f"{df['Years'].min()} YEAR{quarter} QUARTER REGISTERED USER , APPOPENS",
...
def Top_insurance_plot_1(df,state):
    ...
    with col1:
        fig_top_insur_bar_1= px.bar(tiy, x= "Quarter", y= "Transaction_amount", hover_data="pincodes",
                                title="TRANSACTION AMOUNT", height=650,width=600, color_discrete_sequence= px.colors.sequential.Burgyl_r)
...
def top_user_plot_1(df,year):
    ...
    fig_top_plot_1=px.bar(tuyg, x="States", y="RegisteredUsers", color="Quarter", width=1000,height=800,
                        color_discrete_sequence=px.colors.sequential.Bluered, hover_name="States",
...
def top_chart_transaction_amount(table_name):
    ...
    fig_amount_3= px.bar(df_3, x="transaction_amount",y="States",title= "AVERAGE 10 OF TRANSACTION AMOUNT",hover_name="States",orientation="h",
...
def top_chart_transaction_count(table_name):
    ...
    fig_amount_3= px.bar(df_3, x="transaction_count",y="States",title= "AVERAGE 10 OF TRANSACTION COUNT",hover_name="States",orientation="h",
                            color_discrete_sequence=px.colors.sequential.Blues_r,height=800,width=1000)
    st.plotly_chart(fig_amount_3)
...
if select =="HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\guvi\project\guvi project\Phonepe\download.png"),width=600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\guvi\project\guvi project\Phonepe\download.jfif"),width=600)
    ...
    with col6:
        st.image(Image.open(r"C:\guvi\project\guvi project\Phonepe\download (1).jfif"),width= 600)
    ...
    with tab2:
        ...
        if method_2 == "Map Insurance":
            ...
            map_insur_Districts(map_trans_tac_y,States)
            ...
            map_insur_Districts(map_trans_tac_y_Q,States)
